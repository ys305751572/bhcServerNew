            ...
            <section id="content" class="container">
                ...
                <div class="block-area shortcut-area">
                    <a class="shortcut tile" href="">
                        <img src="${contextPath}/html/img/shortcuts/money.png" alt="">
                        <small class="t-overflow">Purchases</small>
                    </a>
                    <a class="shortcut tile" href="">
                        <img src="${contextPath}/html/img/shortcuts/twitter.png" alt="">
                        <small class="t-overflow">Tweets</small>
                    </a>
                    <a class="shortcut tile" href="">
                        <img src="${contextPath}/html/img/shortcuts/calendar.png" alt="">
                        <small class="t-overflow">Calendar</small>
                    </a>
                    <a class="shortcut tile" href="">
                        <img src="${contextPath}/html/img/shortcuts/stats.png" alt="">
                        <small class="t-overflow">Statistics</small>
                    </a>
                    <a class="shortcut tile" href="">
                        <img src="${contextPath}/html/img/shortcuts/connections.png" alt="">
                        <small class="t-overflow">Connection</small>
                    </a>
                    <a class="shortcut tile" href="">
                        <img src="${contextPath}/html/img/shortcuts/reports.png" alt="">
                ...
                <div class="chat">
                    ...
                    <div class="pull-left chat-list">
                        <div class="listview narrow">
                            <div class="media">
                                <img class="pull-left" src="${contextPath}/html/img/profile-pics/1.jpg" width="30" alt="">
                                <div class="media-body p-t-5">
                                    Alex Bendit
                                </div>
                            </div>
                            <div class="media">
                                <img class="pull-left" src="${contextPath}/html/img/profile-pics/2.jpg" width="30" alt="">
                                <div class="media-body">
                                    <span class="t-overflow p-t-5">David Volla Watkinson</span>
                                </div>
                            </div>
                            <div class="media">
                                <img class="pull-left" src="${contextPath}/html/img/profile-pics/3.jpg" width="30" alt="">
                                <div class="media-body">
                                    <span class="t-overflow p-t-5">Mitchell Christein</span>
                                </div>
                            </div>
                            <div class="media">
                                <img class="pull-left" src="${contextPath}/html/img/profile-pics/4.jpg" width="30" alt="">
                                <div class="media-body">
                                    <span class="t-overflow p-t-5">Wayne Parnell</span>
                                </div>
                            </div>
                            <div class="media">
                                <img class="pull-left" src="${contextPath}/html/img/profile-pics/5.jpg" width="30" alt="">
                                <div class="media-body">
                                    <span class="t-overflow p-t-5">Melina April</span>
                                </div>
                            </div>
                            <div class="media">
                                <img class="pull-left" src="${contextPath}/html/img/profile-pics/6.jpg" width="30" alt="">
                                <div class="media-body">
                    ...
                    <div class="media-body">
                        ...
                        <div class="chat-body">
                            <div class="media">
                                <img class="pull-right" src="${contextPath}/html/img/profile-pics/1.jpg" width="30" alt="" />
                            ...
                            <div class="media pull-right">
                                <img class="pull-right" src="${contextPath}/html/img/profile-pics/2.jpg" width="30" alt="" />
                                <div class="media-body">
