...
<!-- jQuery -->
<script src="${contextPath}/html/js/jquery.min.js"></script>
<!-- jQuery Library -->
<script src="${contextPath}/html/js/jquery-ui.min.js"></script>
<!-- jQuery UI -->
<script src="${contextPath}/html/js/jquery.easing.1.3.js"></script>
...
<!-- Flot Main -->
<script src="${contextPath}/html/js/charts/jquery.flot.time.js"></script>
<!-- Flot sub -->
<script src="${contextPath}/html/js/charts/jquery.flot.animator.min.js"></script>
<!-- Flot sub -->
<script src="${contextPath}/html/js/charts/jquery.flot.resize.min.js"></script>
<!-- Flot sub - for repaint when resizing the screen -->

<script src="${contextPath}/html/js/sparkline.min.js"></script>
<!-- Sparkline - Tiny charts -->
<script src="${contextPath}/html/js/easypiechart.js"></script>
<!-- EasyPieChart - Animated Pie Charts -->
<script src="${contextPath}/html/js/charts.js"></script>
<!-- All the above chart related functions -->

<!-- Map -->
<script src="${contextPath}/html/js/maps/jvectormap.min.js"></script>
<!-- jVectorMap main library -->
<script src="${contextPath}/html/js/maps/usa.js"></script>
<!-- USA Map for jVectorMap -->

<!-- UX -->
<script src="${contextPath}/html/js/scroll.min.js"></script>
<!-- Custom Scrollbar -->
...
<script src="${contextPath}/html/js/autosize.min.js"></script>
<!-- Textare autosize -->
<script src="${contextPath}/html/js/toggler.min.js"></script>
<!-- Toggler -->
<script src="${contextPath}/html/js/input-mask.min.js"></script>
<!-- Input Mask -->
<script src="${contextPath}/html/js/spinner.min.js"></script>
<!-- Spinner -->
...
<!-- Text Editor -->
<script src="${contextPath}/html/js/editor2.min.js"></script>
<!-- WYSIWYG Editor -->
<script src="${contextPath}/html/js/markdown.min.js"></script>
<!-- Markdown Editor -->
...
<script src="${contextPath }/static/js/plugins/dataTables/jquery.dataTables.js"></script>
<script src="${contextPath }/static/js/plugins/dataTables/dataTables.bootstrap.js"></script>
