        ...
        <form action="${contextPath}/admin/doctor/save" method="post" enctype="multipart/form-data" class="box tile animated active form-validation-1">
            <div class="block-area">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 m-b-15">
                        <label>职业</label>
                        <input type="text" id="level" name="level" class="input-sm form-control validate[required]" placeholder="...">
                    </div>

                    <div class="col-md-6 m-b-15">
                        <label>科室</label>
                        <input type="text" id="depart" name="depart" class="input-sm form-control validate[required]" placeholder="...">
                    </div>

                    <div class="col-md-6 m-b-15" >
                        <label>所在医院</label>
                        <input type="text" id="hospital" name="hospital" class="input-sm form-control validate[required]" placeholder="...">
                    </div>

                    <div class="col-md-6 m-b-15" >
                        <label>所获奖励</label>
                        <input type="text" id="reward" name="reward" class="input-sm form-control validate[required]" placeholder="...">
                    </div>

                    <div class="col-md-6 m-b-15" >
                        <label>擅长领域</label>
                        <input type="text" id="domain" name="domian" class="input-sm form-control validate[required]" placeholder="..." >
                    </div>
                    <div class="col-md-6 m-b-15">
                        <label>性别</label>
