            ...
            <div class="block-area">
                ...
                <div class="row">
                    <div class="col-md-6 m-b-15">
                        <label>标题</label>
                        <input type="text" id="title" name="title" value="${info.title}" class="input-sm form-control validate[required]" placeholder="..." disabled>
                    </div>
                    <hr class="whiter m-t-20"/>
                    <div class="col-md-6 m-b-15">
                        <label>内容</label>
                        <textarea id="content2" name="content" class="form-control auto-size m-b-10" placeholder="..." disabled>${info.content}</textarea>
                    </div>
                    <hr class="whiter m-t-20"/>
                    <div class="col-md-12 m-b-15">
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            ...
                            <p></p>
                            <p></p>
                            <a href="${info.path}" data-rel="gallery"  class="pirobox_gall img-popup" title="Lovely evening in Noreway">
